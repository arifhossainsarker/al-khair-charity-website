...
Route::middleware('auth', 'isAdmin', 'user.permission')->group(function () {
    // Other pages
    ...
    Route::get('blog/comment', [CommentController::class,'index'])->name('back.blog.comment');
    Route::post('blog/comment/update{comment}', [CommentController::class,'update'])->name('back.blog.comment.update');
    Route::delete('blog/comment/remove{comment}', [CommentController::class,'remove'])->name('back.blog.comment.remove');
    ...
    Route::get('back/donation/categories', [DonationController::class, 'categories'])->name('back.donation.categories');
    Route::get('back/donation/categories/edit/{id}', [DonationController::class, 'categoriesCreate'])->name('back.donation.categories.edit');
    Route::get('donation/remove-image/{donation}', [DonationController::class, 'removeImage'])->name('back.donation.removeImage');
