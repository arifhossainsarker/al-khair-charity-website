                    ...
                    <div class="row">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0 flex-grow-1">Edit Research</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('back.research.update', $research->id) }}" method="POST"
                                    ...
                                    <div class="row live-preview">
                                        <div class="col-lg-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sub_title" name="sub_title"
                                                    value="{{ old('sub_title') ?? $research->sub_title }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="editor" class="form-label">Description <b
                                                        style="color: red;">*</b></label>
                                                <textarea class="form-control" id="editor" placeholder="Enter the Description" name="description">{{ old('description') ?? $research->description }}</textarea>
                                            </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="img_group">
                                                @if ($research->media_id)
                                                    <img class="img-thumbnail uploaded_img"
                                                        src="{{ $research->img_paths['small'] }}">

                                                    <a href="{{ route('back.people-list.removeImage', $research->id) }}"
