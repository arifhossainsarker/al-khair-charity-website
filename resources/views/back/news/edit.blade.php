                    ...
                    <div class="row">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0 flex-grow-1">Edit News</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('back.news.update', $news->id) }}" method="POST"
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sub_title" name="sub_title"
                                                    value="{{ old('sub_title') ?? $news->sub_title }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="editor" class="form-label">Description <b
                                                        style="color: red;">*</b></label>
                                                <textarea class="form-control" id="editor" placeholder="Enter the Description" name="description">{{ old('description') ?? $news->description }}</textarea>
                                            </div>
                                                ...
                                                <h4 style="margin: 30px 0; text-align:center;">SEO</h2>
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="title"
                                                                name="meta_tags"
                                                                value="{{ old('meta_tags') ?? $news->meta_tags }}">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="img_group">
                                                @if ($news->feature_type == 0)
                                                    <img class="img-thumbnail uploaded_img"
                                                        src="{{ $news->img_paths['small'] }}">

                                                    @if ($news->media_id)
                                                        <a href="{{ route('back.news.removeImage', $news->id) }}"
                                                            onclick="return confirm('Are you sure to remove?');"
                                                            class="btn btn-sm btn-danger remove_image"
                                                            title="Remove image"><i class="ri-delete-bin-5-line"></i></a>
                                                    @endif
                                                @else
                                                    {!! $news->video_html !!}
                                                @endif
                                                ...
                                                <div class="form-group text-center">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input feature_type_radio" type="radio"
                                                            name="feature_type" id="feature_type_1" value="0"
                                                            {{ $news->feature_type == 0 ? 'checked' : '' }}>
                                                    ...
                                                    <div class="text-left ft_video form-group" style="display: none">
                                                        <input type="text"
                                                            class="form-control form-control-sm feature_video"
                                                            name="feature_video" value="{{ $news->feature_video }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
                                            ...
                                            <div class="form-group mt-2">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input video_radio" type="radio"
                                                        name="video_type" id="video_type_1" value="File"
                                                        {{ $news->video_type == 'File' ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input video_radio" type="radio"
                                                        ...
                                                        {{ $news->video_type == 'Embade Code' ? 'checked' : '' }}>
                                                ...
                                                <input type="file" name="video" accept="video/*"
                                                    ...
                                                    style="{{ $news->video_type == 'Embade Code' ? 'display: none' : '' }}">

                                                <textarea name="video_embade_code" class="form-control mt-2 video_embade_code"
                                                    style="{{ $news->video_type == 'File' ? 'display: none' : '' }}" cols="30" rows="5"
                                                    placeholder="Video embade code">{{ old('video_embade_code') ?? $news->video_embade_code }}</textarea>

                                                @if ($news->video_type == 'File')
                                                    <video style="width: 100%;height:auto;" class="mt-2" controls
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="exampleInputdate"
                                                    name="publish_date"
                                                    value="{{ old('publish_date') ?? $news->publish_date }}">
                                            </div>
                                            <br>
                                            <div class="col-12">
