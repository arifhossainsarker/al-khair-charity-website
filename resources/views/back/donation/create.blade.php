                    ...
                    <div class="row">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0 flex-grow-1">Create Donation</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('back.donation.store') }}" method="POST"
                                    ...
                                    <div class="row live-preview">
                                        <div class="col-lg-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="aeditor" placeholder="Enter your Address" name="address">{{ old('address') }}</textarea>
                                            </div>
