                ...
                <div
                    ...
                    <div class="p-5 bg-white md:flex-1">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="flex flex-col space-y-5">
                            ...
                            <div>
                                <button type="submit"
                                    class="w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 primary-bg rounded-md shadow hover:bg-sky-500 focus:outline-none focus:ring-sky-200 focus:ring-4">
                                    Register
                                </button>
                            </div>
                        </form>
