                                    ...
                                    <template v-if="section_design_id===3">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="raised_amount" step="any" placeholder="raised amount write here..">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label><b>Raised Percentage</b></label>
                                                <input type="number" class="form-control" name="raised_percentage" step="any" placeholder="raised percentage write here..">
                                            </div>
                                        </div>
                                    </template>
                                </template>
